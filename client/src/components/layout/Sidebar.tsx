...
import {
  ...
  CalendarDays, DollarSign, UserPlus, TrendingUp, GraduationCap, FileText,
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-slate-700 p-3 flex-shrink-0">
        {collapsed ? (
          <button className="text-slate-400 hover:text-red-400 transition-colors p-2 mx-auto flex" title="Logout">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button className="text-slate-400 hover:text-red-400 transition-colors p-1 flex-shrink-0" title="Logout">
              <LogOut className="w-4 h-4" />
            </button>
          </div>
        )}
